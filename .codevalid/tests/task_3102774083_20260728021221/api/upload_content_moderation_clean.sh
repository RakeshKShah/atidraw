...
printf 'multipart upload clean jpeg drawing=@%s\n' "$DRAWING_FILE" > "$REQ_BODY_LOG"

# Given
echo "STEP: Given — bootstrap authenticated session and clean jpeg payload"
...
# When
echo "STEP: When — perform POST /api/upload with clean jpeg"
echo "REQUEST_HEADERS:"
