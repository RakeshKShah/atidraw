...
CASE_SUFFIX="$(date +%s)-$$"
COOKIE_JAR="/tmp/ai_description_generation_failure_returns_empty_description_header_cookie_${CASE_SUFFIX}.txt"
AUTH_HEADERS="/tmp/ai_description_generation_failure_returns_empty_description_header_auth_headers_${CASE_SUFFIX}.txt"
AUTH_BODY="/tmp/ai_description_generation_failure_returns_empty_description_header_auth_body_${CASE_SUFFIX}.txt"
