...
echo "STEP: Given — target empty synchronized storage behavior"
echo "PREREQ: Environment may or may not actually be empty; assert graceful 200 response with blobs array"
...
echo "STEP: Then — assert graceful empty-or-nonempty list response contract"
...
echo "CODEVALID_TEST_ASSERTION_OK:empty_blob_list"
